...
export default class RegionNorth extends Component {
    ...
    submitQuery() {
        ...
        this.state.queryOptions['STARTDATETIME'] = get_StartTime_Select();
        this.state.queryOptions['STOPDATETIME'] = get_StopTime_Select();
        this.state.queryOptions['NETTYPE'] = get_NetType_Select();
        this.state.queryOptions['LTEITEM'] = get_LTEITEMS_Select();
        this.state.queryOptions['GSMITEM'] = get_GSMITEMS_Select();
                        ...
                        <table cellPadding="5">
                          <tbody>
                            <tr>
                                ...
                                <td>MME:</td>
                                <td><input id="MME_SELECT" className="easyui-combobox" name="mme_select" data-options="url:'./reactjs/data/combobox_causeproc.json', method:'get', valueField:'id', textField:'text',multiple:true,multiline:true,panelHeight:'auto'" style={{width:'400px',height:'25px'}}  /> </td>
                            </tr>
                            <tr>
                                <td>起始时间:</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="NETTYPE_SELECT" className="easyui-combobox" name="nettype_select" data-options="multiple:true,multiline:true"  style={{width:'200px',height:"25px"}}>
                                        <option defaultValue="LTE" >LTE</option>
                                        <option value="GSM">GSM/UMTS</option>
		                             </select>
                                </td>
