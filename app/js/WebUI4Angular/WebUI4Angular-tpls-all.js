angular.module("ui.wisoft",["ui.wisoft.tpls","ui.wisoft.position","ui.wisoft.transition","ui.wisoft.bindHtml","ui.wisoft.popup","ui.wisoft.resizelistener","ui.wisoft.dialog","ui.wisoft.collapse","ui.wisoft.menu","ui.wisoft.imageview","ui.wisoft.progress","ui.wisoft.common","ui.wisoft.alert","ui.wisoft.carousel","ui.wisoft.fileupload","ui.wisoft.accordion","ui.wisoft.messagetip","ui.wisoft.my97datepicker","ui.wisoft.panel","ui.wisoft.combobox","ui.wisoft.popupbutton","ui.wisoft.button","ui.wisoft.datagrid","ui.wisoft.dividedbox","ui.wisoft.searchinput","ui.wisoft.tabset","ui.wisoft.tilelist","ui.wisoft.tooltip","ui.wisoft.camerascanner","ui.wisoft.tree"]);
...
//                    scope.collapse = (scope.collapse!='false');
                    ...
                    if(scope.dataurl){ // 定义了 dataurl，则 dataprovider 失效
                        ...
                        scope.$watchCollection('dataprovider',function(newValue, oldValue){
                            //console.log('watch dataprovider in initscope');
                            if(newValue != oldValue){
                    ...
                    scope.$watchCollection('columns',function(newValue, oldValue){
                            //console.log('watch columns in initscope');
                            if(newValue != oldValue){
                                // add by huykai
                                //initScope();
                                colIndex = 0;
                                console.log('watch columns in initscope and found change!');
                                console.log('getColsByColumns in initscope : old head is :');
                                console.log(oldValue);
                                console.log('getColsByColumns in initscope : new head is :');
                                ...
                                getColsByColumns();
                                console.log('getColsByColumns in initscope : after getColsByColumns is :');
                                console.log(scope.heads[0]);
                                console.log('getColsByColumns in initscope : new head after getColsByColumns is :');
                                console.log(scope.heads);
                                
                                headarray = scope.headarray = initHeadArray();
